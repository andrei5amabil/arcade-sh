...
export default function LeaderboardTable() {
  ...
  return (
    <div className="border border-[#414868] rounded-lg bg-[#24283b] shadow-2xl">
      ...
      <div className="bg-[#414868] p-2 flex gap-2 rounded-t-lg">
        ...
        <span className="text-xs ml-2 opacity-70">~/arcade/leaderboard</span>
      </div>

      <div className="p-6">
        <h1 className="text-sm font-bold tracking-[0.2em] text-[#7aa2f7]">{'>'} GLOBAL_LEADERBOARD</h1>
